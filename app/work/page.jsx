...
const projects = [
	{
		...
		tite: "Project 1",
		description:
			"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni voluptatem asperiores blanditiis sequi eos illum error qui expedita id nulla?",
		stack: [{ name: "Html5" }, { name: "CSS3" }, { name: "Javascript" }],
		image: "/img/work/thumb1.png",
		live: "",
		github: "",
	},
	{
		...
		>
			<div className="container mx-auto">
				<div className="flex flex-col xl:flex-row xl:gap-[30px]">
					...
					<div className="w-full xl:w-1/2 xl:h-[460px]">
						<Swiper
							spaceBetween={30}
							slidesPerView={1}
